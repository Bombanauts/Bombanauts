...
VolumetricFire.prototype.slice = function() {
  ...
  let cornerDistance = [cornerDistance0];
  let maxCorner = 0;
  ...
  for (i = 0; i < 3; i = (i + 1) | 0) {
    let activeEdge = createEdge.call(this, maxCorner, cornerNeighbors[maxCorner][i]);
